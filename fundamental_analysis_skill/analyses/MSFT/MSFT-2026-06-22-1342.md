...
**Ticker**: MSFT | **Exchange**: N/A | **Date**: 2026-06-22 | **Current Price**: $370.2
...
Microsoft Corporation trades at LOW levels (7.5% of 52-week range).

**Current Market Data:**
- Current Price: USD $370.2
...
### Current Position
- **Current Price**: USD $370.24
- **52-Week Range**: $355.51 - $551.05
- **Position in Range**: 7.5% (-32.8% from high, +4.1% from low)
- **Trading Volume**: 26,189,106 (0.68x average)
...
**Last Data Update**: 2026-06-22 13:43:23
...
### Data Sources
- Price data: Yahoo Finance (fetched 2026-06-22)
...
3. **Validation Phase**:
   - Run: `python scripts/validate_report_data.py MSFT --report <this_file>`
...
4. **Finalization**:
   ...
   - Archive with proper naming: `MSFT-YYYY-MM-DD.md`

---

**Report Generated**: 2026-06-22 13:42:51
